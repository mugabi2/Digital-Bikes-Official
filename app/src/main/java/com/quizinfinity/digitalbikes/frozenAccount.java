...
public class frozenAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar=findViewById(R.id.toolbarfrozen);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_profile:
                startActivity(new Intent(frozenAccount.this, profile.class));
                break;
            case R.id.action_safetytips:
                startActivity(new Intent(frozenAccount.this, safetyTips.class));
                break;
